from data_ho_s4 import QmdlDataset
...
def main(
    ...
    # data train
    path_project = Path('../')
    path_data_1 = Path('data.handover/trip_1.forward/')
    path_rawlogs_list_1 = [path_project / path_data_1 / Path(f'qmdl_{i}.qmdl') for i in range(1, 20+1)]
    path_data_2 = Path('data.handover/trip_1.backward/')
    ...
    # data test
    path_test_data = Path('data.handover/trip_2.samples/')
